...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    # Add batch normalization and Add recurrent layer
    layer = BatchNormalization(name='layer_0')(conv_1d)
    layer = GRU(units, activation='relu',return_sequences=True, implementation=2, dropout=0.5)(layer)
    layer = BatchNormalization(name='layer_1')(layer)
    #layer = LSTM(units, return_sequences=True, activation='relu')(layer)
    #layer = BatchNormalization(name='layer_2')(layer)
        
    # Add recurrent layer
    #if recur_layers >1:
    #    for i in range(recur_layers - 1):
    #        layer = LSTM(units, return_sequences=True, activation='relu')(layer)
    #        layer = BatchNormalization(name='layer_{}'.format(1+i))(layer)
